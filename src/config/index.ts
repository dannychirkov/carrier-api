...
export interface NovaPoshtaClientConfig {
  ...
  /** Environment (affects base URL and logging) */
  readonly environment: 'production' | 'staging' | 'development';
  /** HTTP transport configuration */
  readonly transport: Partial<TransportConfig>;
...
export const ENVIRONMENT_CONFIGS: Record<string, Partial<TransportConfig>> = {
  production: {
...
export class ConfigBuilder {
  ...
  /** Set environment */
  environment(environment: 'production' | 'staging' | 'development'): this {
    (this.config as any).environment = environment;
    return this;
  }
  ...
  build(): NovaPoshtaClientConfig {
    ...
    const environment = this.config.environment || DEFAULT_CLIENT_CONFIG.environment;
    const environmentTransportConfig = ENVIRONMENT_CONFIGS[environment] || {};
...
export function createProductionConfig(apiKey: string): NovaPoshtaClientConfig {
...
export function createDevelopmentConfig(apiKey: string): NovaPoshtaClientConfig {
  return createConfig(apiKey)
...
export function loadConfigFromEnv(apiKey?: string): Partial<NovaPoshtaClientConfig> {
  ...
  return {
    ...
    environment: (env['NOVA_POSHTA_ENVIRONMENT'] as 'production' | 'staging' | 'development') || 'production',
